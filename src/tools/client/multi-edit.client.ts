...
import { multiEditToolDef, type MultiEditInput, type MultiEditOutput } from "../definitions/multi-edit";

/**
 * Client-side multi-edit tool.
 * After approval, this calls the server-side execution API.
 */
export const multiEditToolClient = multiEditToolDef.client(async (args: MultiEditInput): Promise<MultiEditOutput> => {
